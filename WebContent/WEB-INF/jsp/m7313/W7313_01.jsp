...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td valign="top"> 
      ...
      <%-- **************可编辑区域开始****************** --%>
      <% if (bFlag){%>
      <form name="form1" method="post" action="W7313_02">
        <table border="0" cellspacing="0" cellpadding="4" align="center">
          <tr> 
            <td nowrap>机构号　： 
              <input type="text" name="MDUNITNO" size="20" class="text" maxlength="11">
            </td>
          </tr>
          <tr> 
            <td nowrap>机构名称： 
              <input type="text" name="MDUNITNAME" size="20" class="text" maxlength="20">
              <b></b></td>
          </tr>
          <tr> 
            <td width="0" nowrap> 
