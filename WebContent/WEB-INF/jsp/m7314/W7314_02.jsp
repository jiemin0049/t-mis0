...
<script language="JavaScript" src="../js/tmis.js"></script>
...
<SCRIPT LANGUAGE="JavaScript">
            function check(){
       if(form1.CUNITNO.length == null)
        {
            if(!document.form1.CUNITNO.checked) {
              alert("请选择一个机构进行删除!");
              return false;
             }
            else {
          ...
          for(var i = 0 ; i < form1.CUNITNO.length ; i ++){
            if(document.form1.CUNITNO[i].checked) {
            return true;
            }
          }
              alert("请选择一个机构进行删除!");
      ...
      <% if (bFlag){%>
      <form name="form1" method="post" action="W7314_03">
        <table border="0" cellspacing="0" cellpadding="4" align="center">
                ...
                <tr align="center"> 
                  <td nowrap> 
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td nowrap> 
                          <input type="radio" name="CUNITNO" value="<c:out value="${unit.unitNr}"/>">
                        </td>
          ...
          <tr> 
            <td nowrap> 
              <div align="center">
                <input type="button" name="back22" value="删 除" onClick="DeleteAction('W7314_03','1')" class="button">
                　
